...
select test.assert((select count(*)=1 from public.athlete_experiences e join public.profiles p on p.id=e.profile_id where p.user_id='40000000-0000-0000-0000-000000000001'),'other owner experience preserved');
