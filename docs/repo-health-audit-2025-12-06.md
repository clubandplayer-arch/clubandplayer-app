...
### Stato corrente nel sandbox
- Non è possibile rigenerare il lockfile qui perché mancano `node`/`pnpm` e il proxy blocca anche `apt-get update` (403 sui mirror Ubuntu), quindi l’aggiornamento del lock resta delegato a un ambiente con rete libera.
