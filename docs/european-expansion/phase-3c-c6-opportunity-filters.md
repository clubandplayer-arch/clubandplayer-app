...
**CONDITIONAL PASS**: implementazione e controlli automatici PASS; verifica manuale Preview richiesta prima di marcare C6 COMPLETATA. C7 non è iniziata.
...
Comunicare PASS/FAIL, URL Preview e scenari/Paesi provati, senza credenziali o UUID sensibili.

## Stato

C6 resta **CONDITIONAL PASS / MANUAL PREVIEW PENDING**. Prossimo passaggio autorizzabile dopo smoke PASS: **C7**, senza avvio automatico.
