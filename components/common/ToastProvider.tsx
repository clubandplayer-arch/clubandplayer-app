...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  const show = useCallback((messageOrConfig: string | ShowConfig, opts: Options = {}) => {
    ...
    if (typeof messageOrConfig === 'string') {
      ...
      variant =
        variant ?? messageOrConfig.variant ?? toneToVariant(messageOrConfig.tone, 'default');

      // scegli cosa mostrare come messaggio base
      message = description ?? title ?? '[toast]'; /* se non arriva nulla evitiamo stringa vuota */
    }
