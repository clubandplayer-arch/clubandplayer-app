...
const SMALL_SIDED_FOOTBALL_ROLES = ['Portiere','Difensore Centrale','Esterno Basso','Regista','Esterno Alto','Punta Centrale'];

const SPORTS_REQUIRING_PLAYER_ROLE = new Set(['Calcio', 'Calcio a 8', 'Calcio a 7']);

export const SPORTS_ROLES: Record<string, string[]> = {
  Calcio: FOOTBALL_ROLES,
  'Calcio a 8': SMALL_SIDED_FOOTBALL_ROLES,
