...
const roleKeys: Record<string, VocabularyMessageKey> = {
  ...
  'playmaker pg':'vocabulary.role.basketballPointGuard', 'guardia sg':'vocabulary.role.basketballShootingGuard', 'ala piccola sf':'vocabulary.role.basketballSmallForward', 'ala grande pf':'vocabulary.role.basketballPowerForward', 'centro c':'vocabulary.role.basketballCenter',
  centroboa:'vocabulary.role.waterPoloCentreForward', 'marcatore hole d':'vocabulary.role.waterPoloCentreBack', 'driver perimetrale':'vocabulary.role.waterPoloDriver', 'punto regista':'vocabulary.role.waterPoloPoint',
  'ala sinistra':'vocabulary.role.leftWing', 'ala destra':'vocabulary.role.rightWing', 'terzino sinistro':'vocabulary.role.leftBack', 'terzino destro':'vocabulary.role.rightBack',
  pilone:'vocabulary.role.rugbyProp', tallonatore:'vocabulary.role.rugbyHooker', 'seconda linea':'vocabulary.role.rugbyLock', flanker:'vocabulary.role.rugbyFlanker', 'numero 8':'vocabulary.role.rugbyNumberEight', 'mediano di mischia':'vocabulary.role.rugbyScrumHalf', apertura:'vocabulary.role.rugbyFlyHalf', centro:'vocabulary.role.centre', estremo:'vocabulary.role.rugbyFullback',
  pitcher:'vocabulary.role.baseballPitcher', catcher:'vocabulary.role.baseballCatcher', 'prima base':'vocabulary.role.firstBase', 'seconda base':'vocabulary.role.secondBase', 'terza base':'vocabulary.role.thirdBase', interbase:'vocabulary.role.shortstop', 'esterno sinistro':'vocabulary.role.leftFielder', 'esterno centro':'vocabulary.role.centerFielder', 'esterno destro':'vocabulary.role.rightFielder', 'battitore designato':'vocabulary.role.designatedHitter',
  lsm:'vocabulary.role.lacrosseLsm', 'faceoff specialist':'vocabulary.role.lacrosseFaceoff', quarterback:'vocabulary.role.americanFootballQuarterback', 'running back':'vocabulary.role.americanFootballRunningBack', 'wide receiver':'vocabulary.role.americanFootballWideReceiver', 'tight end':'vocabulary.role.americanFootballTightEnd', 'offensive lineman':'vocabulary.role.americanFootballOffensiveLineman', 'defensive lineman':'vocabulary.role.americanFootballDefensiveLineman', linebacker:'vocabulary.role.americanFootballLinebacker', cornerback:'vocabulary.role.americanFootballCornerback', safety:'vocabulary.role.americanFootballSafety', 'kicker punter':'vocabulary.role.americanFootballKickerPunter',
