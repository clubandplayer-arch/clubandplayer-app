...
export default async function ClubPublicProfilePage({ params }: { params: { id: string } }) {
  ...
  const canonicalCategoryLabel = localizeOpportunityCategory(primaryRegistration?.category?.canonical_name, t) ?? categoryLabel;
  const subtitle =
