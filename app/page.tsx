    ...
    <main className="min-h-[80vh] grid place-items-center bg-gradient-to-b from-white to-[#f6f8fb]">
      <div className="w-full max-w-3xl text-center px-6 py-14">
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
          ...
          <br />
          <span className="text-brand">Club</span> <span className="text-accent">&</span>{' '}
          <span className="text-brand">Player</span>
        </h1>

        <p className="text-gray-600 mb-8">
          Crea il tuo profilo come <b>Atleta</b> o <b>Club</b>, pubblica opportunità e invia candidature.
          Un’esperienza familiare in stile LinkedIn, pensata per il mondo sportivo.
        </p>
