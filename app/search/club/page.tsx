...
export default function SearchClubPage() {
  ...
  return (
    <main style={{ maxWidth: 1024, margin: '0 auto', padding: 24 }}>
      ...
      <section
        style={{ border: '1px solid #e5e7eb', borderRadius: 12, padding: 12, marginTop: 12 }}
      >
        <div
          style={{
            display: 'grid',
        ...
        >
          <div>
            <label style={{ display: 'block', fontSize: 12, opacity: 0.7 }}>Nome club</label>
            <input
              value={name}
          ...
          <div>
            <label style={{ display: 'block', fontSize: 12, opacity: 0.7 }}>Città</label>
            <input
              value={city}
      ...
      <section style={{ display: 'grid', gap: 12, marginTop: 12 }}>
        ...
        {items.map((c) => (
          <div key={c.id} style={{ border: '1px solid #e5e7eb', borderRadius: 12, padding: 16 }}>
            ...
            >
              <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 14, opacity: 0.8 }}>{c.city ?? '—'}</div>
                </div>
              </div>
              <div>
            ...
            {c.bio && (
              <p
                style={{ margin: '8px 0 0 0', fontSize: 14, opacity: 0.85, whiteSpace: 'pre-wrap' }}
              >
                {c.bio}
              </p>
            )}
